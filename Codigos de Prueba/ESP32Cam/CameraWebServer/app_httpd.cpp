...
bool custom_camera_capture(uint32_t img_width, uint32_t img_height, uint8_t *out_buf) {
...
static esp_err_t capture_handler(httpd_req_t *req) {
  ...
  snapshot_buf = (uint8_t*)malloc(EI_CAMERA_RAW_FRAME_BUFFER_COLS * EI_CAMERA_RAW_FRAME_BUFFER_ROWS * EI_CAMERA_FRAME_BYTE_SIZE);
    ...
    if (custom_camera_capture((size_t)EI_CLASSIFIER_INPUT_WIDTH, (size_t)EI_CLASSIFIER_INPUT_HEIGHT, snapshot_buf) == false) {
