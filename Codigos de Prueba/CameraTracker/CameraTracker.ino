...
void inferenceLoop(void * parameter) {
    ...
    while(true) {
        ...
        if (xSemaphoreTake(fbMutex, portMAX_DELAY) == pdTRUE)  {
          ...
          //Asumo -> s1 es el servo que se mueve en X y s2 en Y. Y que (0,0) es arriba a la izquierda. Capaz es necesario cambiarlo.
          ...
          if(cualServo == anda){
            ...
            if(servoPosX < 45) servoPosX = 45;
            if(servoPosX > 135) servoPosX = 135;
